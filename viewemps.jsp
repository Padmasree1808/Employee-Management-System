        		  ...
        		  <c:forEach items="${empList}" var="employee">
        		  		<tr>
							...
							<td>${employee.password}</td>
        		  			...
        		  			<td>
        		  				<a href = 'edit?id=${employee.id}&email=${employee.email}&password=${employee.password}&name=${employee.name}&age=${employee.age}&mobile=${employee.mobile}&department=${employee.department}&address=${employee.address}'>Edit</a>
        		  			</td>
        		  			<td>
